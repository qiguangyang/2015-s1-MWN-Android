...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		navDrawerItems.add(new NavDrawerItem(navMenuTitles[3], navMenuIcons.getResourceId(3, -1), true, "8" ));
		// Help
...
//	}
	...
	private void displayView(int position) {
		...
		case 1:
			...
			break;
		case 2:
			fragment = new ConfigureReaderFragment();
			break;
		case 3:
			fragment = new PriorityTaskFragment();
			break;
		case 4:
